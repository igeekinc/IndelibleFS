...
public interface CASServerInternal<T extends CASServerConnectionIF> extends CASServer<T>
{
    public T open(EntityID openingEntity);
    public T open(EntityAuthentication openingEntity);
    void close(T closeConnection);
