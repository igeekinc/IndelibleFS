...
public abstract class CASServerEventIterator implements
		IndelibleEventIterator
{

	protected CASServerConnection connection;
	protected CASServerEvent []	cachedEvents;
	protected int	offset;
	protected long	lastEventID;
	protected boolean	closed	= false;

	public CASServerEventIterator(CASServerConnection connection)
	{
